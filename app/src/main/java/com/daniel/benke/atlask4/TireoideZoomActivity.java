...
public class TireoideZoomActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tireoidezoom);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), TireoideZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("folículos");
        spec.setContent(R.id.tab2);
        spec.setIndicator("folículos");
        host.addTab(spec);
        ...
        //Tab 4
        spec = host.newTabSpec("colóide");
        spec.setContent(R.id.tab4);
        spec.setIndicator("colóide");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"tireoidez"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), TireoideTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
