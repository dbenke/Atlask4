...
public class PeleActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pele);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom 1") {
                    Intent nextScreen = new Intent(getApplicationContext(), EsofagoZoom1Activity.class);
                    startActivity(nextScreen);}

                if (current=="Zoom 2") {
                    Intent nextScreen = new Intent(getApplicationContext(), EsofagoZoom2Activity.class);
                    startActivity(nextScreen);}
            }
        });
        ...
        //Tab 3
        spec = host.newTabSpec("queratina");
        spec.setContent(R.id.tab3);
        spec.setIndicator("queratina");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"pele"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), PeleTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
