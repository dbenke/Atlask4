...
public class MandibularActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv8 = (ImageView) findViewById(R.id.itab8);
        ...
        iv6.setScaleType(ImageView.ScaleType.FIT_START);
        iv7.setScaleType(ImageView.ScaleType.FIT_START);
        iv8.setScaleType(ImageView.ScaleType.FIT_START);
        ...
        setTitle("Glândula submandibular");
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), MandibularZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("lóbulo");
        spec.setContent(R.id.tab2);
        spec.setIndicator("lóbulo");
        host.addTab(spec);
        ...
        //Tab 6
        spec = host.newTabSpec("conjuntivio");
        spec.setContent(R.id.tab6);
        spec.setIndicator("conjuntivo");
        host.addTab(spec);

        //Tab 7
        spec = host.newTabSpec("septos");
        spec.setContent(R.id.tab7);
        spec.setIndicator("septos");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"mandibular"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), MandibularTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
...
*/
    ...
    private class ScaleListener extends ScaleGestureDetector.
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            scale = Math.max(0.35f, Math.min(scale, .95f));
