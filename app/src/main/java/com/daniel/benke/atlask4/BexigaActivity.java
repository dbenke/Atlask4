...
public class BexigaActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"bexiga"+current+", ");
...
*/
    ...
    private class ScaleListener extends ScaleGestureDetector.
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            scale = Math.max(1.6f, Math.min(scale, 5.0f));
