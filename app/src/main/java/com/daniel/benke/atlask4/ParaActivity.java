...
public class ParaActivity extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Tab 2
        spec = host.newTabSpec("paratireóide");
        spec.setContent(R.id.tab2);
        spec.setIndicator("paratireóide");
        host.addTab(spec);
        ...
        //Tab 4
        spec = host.newTabSpec("tireóide");
        spec.setContent(R.id.tab4);
        spec.setIndicator("tireóide");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"para"+current+", ");
